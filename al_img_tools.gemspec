Gem::Specification.new do |spec|
  ...
  spec.description   = "Jekyll plugin extracted from al-folio that provides image tool styles/scripts for zoom, galleries, sliders, comparisons, and lightbox integrations."
  ...
  spec.add_dependency "jekyll-3rd-party-libraries", "~> 0.0.1"
